...
public final class DateUtils {
  ...
  public static String toStringYYYYMMDDHHMMSSSSS(OffsetDateTime date, ZoneId zoneId) {
    if (date == null || zoneId == null) {
      return "";
    }
    return date.toInstant().atZone(zoneId)
  ...
  public static String toStringNano(OffsetDateTime date, ZoneId zoneId) {
    if (date == null || zoneId == null) {
      return "";
    }
    return date.toInstant().atZone(zoneId)
  ...
  public static OffsetDateTime parseISO8601OffsetDate(String strDate) {
    ZonedDateTime dateTime = ZonedDateTime.parse(strDate,
            DateTimeFormatter.ofPattern("yyyy-MM-dd'T'HH:mm:ssXXX"));
